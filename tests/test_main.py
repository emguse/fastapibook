...
@pytest.mark.parametrize(
    ...
    [
        ("2025-12-01", starlette.status.HTTP_200_OK),
        ("2025-12-32", starlette.status.HTTP_422_UNPROCESSABLE_ENTITY),
        ("2025/12/01", starlette.status.HTTP_422_UNPROCESSABLE_ENTITY),
        ("2025-1232", starlette.status.HTTP_422_UNPROCESSABLE_ENTITY),
    ],
)
